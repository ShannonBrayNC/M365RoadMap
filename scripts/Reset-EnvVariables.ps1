...
$env:GRAPH_TENANT_ID = "38ac7b7f-65e1-4a2a-8e3a-7bbe18659ebe"
$env:GRAPH_CLIENT_ID = "5adca85e-5309-4f49-8c8d-044fccc637f0"
$env:M365_PFX_BASE64 = [Convert]::ToBase64String([IO.File]::ReadAllBytes("C:\echomediaai\EchoMediaAi_Graph.pfx"))
$env:M365_PFX_PASSWORD = "EdenEcho!"

python scripts/fetch_messages_graph.py --no-window --emit csv --out output/nofilter.csv
